      repeat
        ...
        task.spawn(function ()
            newBillboard.Name = "aleel_billboarddot"
        ...
        RunService.Stepped:Connect(function ()
            if aleel.Aiming.Target.Enabled and TargetBindEnabled and TargetTarget.Character then
                if aleel.Aiming.Target.Dot.Enabled then
                    DotParent.CFrame = CFrame.new(TargetTarget.Character[aleel.Aiming.Target.Hitbox].Position+Vector3.new(0,aleel.Aiming.Target.Offset.Y,0)+(TargetTarget.Character[aleel.Aiming.Target.Hitbox].Velocity*aleel.Aiming.Target.Prediction))
                    task.spawn(function ()
                        newFrame.BackgroundColor3 = aleel.Aiming.Target.Dot.Color
                    end)
                    spawn(function ()
                        if aleel.Aiming.Target.Dot.Enabled == false then
                            DotParent.CFrame = CFrame.new(0,2000,0)
                        end
                    end)
                end
                if aleel.Aiming.Target.FakeHitbox.Enabled then
                    FakeHitboxPart.CFrame = CFrame.new(TargetTarget.Character.HumanoidRootPart.Position+Vector3.new(0,aleel.Aiming.Target.Offset.Y,0)+(TargetTarget.Character.HumanoidRootPart.Velocity*aleel.Aiming.Target.Prediction))
                    spawn(function ()
                        if aleel.Aiming.Target.FakeHitbox.Enabled == false then
                    ...
                    task.spawn(function ()
                        ...
                        FakeHitboxPart.Color = aleel.Aiming.Target.FakeHitbox.Color
                        FakeHitboxPart.Size = Vector3.new(1*aleel.Aiming.Target.FakeHitbox.Size,1*aleel.Aiming.Target.FakeHitbox.Size,1*aleel.Aiming.Target.FakeHitbox.Size)
                        if aleel.Aiming.Target.FakeHitbox.Material == "Neon" then
                            FakeHitboxPart.Transparency = 0
                            FakeHitboxPart.Material = "Neon"
                        end
                        if aleel.Aiming.Target.FakeHitbox.Material == "ForceField" then
                            FakeHitboxPart.Transparency = 0
                            FakeHitboxPart.Material = "ForceField"
                        end
                        if aleel.Aiming.Target.FakeHitbox.Material == "Plastic" then
                            FakeHitboxPart.Transparency = 0.75
                            FakeHitboxPart.Material = "Plastic"
                        end
                    end)
                end
                if aleel.Aiming.Target.ViewAt then
                    workspace.CurrentCamera.CameraSubject = TargetTarget.Character.Humanoid
                    spawn(function ()
                        if aleel.Aiming.Target.ViewAt == false then
                            workspace.CurrentCamera.CameraSubject = LocalPlayer.Character.Humanoid
                        end
                    end)
                end
                if aleel.Aiming.Target.Tracer.Enabled then
                    local LineVec = workspace.CurrentCamera:WorldToViewportPoint(TargetTarget.Character[aleel.Aiming.Target.Hitbox].Position+Vector3.new(0,aleel.Aiming.Target.Offset.Y,0)+(TargetTarget.Character[aleel.Aiming.Target.Hitbox].Velocity*aleel.Aiming.Target.Prediction))
                    ...
                    TracerLine.Color = aleel.Aiming.Target.Tracer.Color
                    TracerLine.Transparency = 1
                    TracerLine.Thickness = 2
                    TracerLine.To = Vector2.new(LineVec.X, LineVec.Y)
                    TracerLine.Visible = true
                    if aleel.Aiming.Target.Tracer.From == "Mouse" then
                        TracerLine.From = Vector2.new(LocalPlayerObjs.Mouse.X, LocalPlayerObjs.Mouse.Y + game:GetService("GuiService"):GetGuiInset().Y)
                    end
                    if aleel.Aiming.Target.Tracer.From == "Head" then
                        TracerLine.From = Vector2.new(headt.X, headt.Y)
                    end
                    if aleel.Aiming.Target.Tracer.From == "UpperTorso" then
                        TracerLine.From = Vector2.new(humanoidt.X, humanoidt.Y)
                    end
                    if aleel.Aiming.Target.Tracer.From == "LowerTorso" then
                        TracerLine.From = Vector2.new(lowert.X, lowert.Y)
                    end
                    if aleel.Aiming.Target.Tracer.From == "Gun" then
                        TracerLine.From = Vector2.new(gunt.X, gunt.Y)
                    end
        
                    spawn(function ()
                        if aleel.Aiming.Target.Tracer.Enabled == false or aleel.Aiming.Target.Enabled == false then
                            TracerLine.Visible = false
                        end
                    end)
                end
                if aleel.Aiming.Target.Highlight.Enabled then
                    HLTarget.Parent = TargetTarget.Character
                    HLTarget.FillColor = aleel.Aiming.Target.Highlight.FillColor
                    HLTarget.OutlineColor = aleel.Aiming.Target.Highlight.OutlineColor
                    spawn(function ()
                        if aleel.Aiming.Target.Highlight.Enabled == false then
                            HLTarget.Parent = game.CoreGui
                        end
                    end)
                end
        
                if aleel.Aiming.TargetStrafe.Visualize.Enabled and aleel.Aiming.TargetStrafe.Enabled then
                    targetstraferangepart.CFrame = TargetTarget.Character.HumanoidRootPart.CFrame
                    spawn(function ()
                        targetstraferangepart.Size = Vector3.new(aleel.Aiming.TargetStrafe.Distance * 0.7, 0.01, aleel.Aiming.TargetStrafe.Distance * 0.7)
                        targetstraferangepart.Color = aleel.Aiming.TargetStrafe.Visualize.Color
                    end)
                    spawn(function ()
                        if aleel.Aiming.TargetStrafe.Visualize.Enabled == false or aleel.Aiming.TargetStrafe.Enabled == false then
            ...
            if aleel.Aiming.Target.PingBased == true then
                pingvalue = game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValueString()
                split = string.split(pingvalue,'(')
                ping = tonumber(split[1])
                if ping < 360 then
                    aleel.Aiming.Target.Prediction = 0.16537
                elseif ping < 270 then
                    aleel.Aiming.Target.Prediction = 0.195566
                elseif ping < 260 then
                    aleel.Aiming.Target.Prediction = 0.175566
                elseif ping < 250 then
                    aleel.Aiming.Target.Prediction = 0.1651
                elseif ping < 240 then
                    aleel.Aiming.Target.Prediction = 0.16780
                elseif ping < 230 then
                    aleel.Aiming.Target.Prediction = 0.15692
                elseif ping < 220 then
                    aleel.Aiming.Target.Prediction = 0.165566
                elseif ping < 210 then
                    aleel.Aiming.Target.Prediction = 0.16780
                elseif ping < 200 then
                    aleel.Aiming.Target.Prediction = 0.165566
                elseif ping < 190 then
                    aleel.Aiming.Target.Prediction = 0.166547
                elseif ping < 180 then
                    aleel.Aiming.Target.Prediction = 0.19284
                elseif ping < 170 then
                    aleel.Aiming.Target.Prediction = 0.1923111 
                elseif ping < 160 then
                    aleel.Aiming.Target.Prediction = 0.16
                elseif ping < 150 then
                    aleel.Aiming.Target.Prediction = 0.15
                elseif ping < 140 then
                    aleel.Aiming.Target.Prediction = 0.1223333
                elseif ping < 130 then
                    aleel.Aiming.Target.Prediction = 0.156692
                elseif ping < 120 then
                    aleel.Aiming.Target.Prediction = 0.143765
                elseif ping < 110 then
                    aleel.Aiming.Target.Prediction = 0.1455
                elseif ping < 100 then
                    aleel.Aiming.Target.Prediction = 0.130340
                elseif ping < 90 then
                    aleel.Aiming.Target.Prediction = 0.136
                elseif ping < 80 then
                    aleel.Aiming.Target.Prediction = 0.1347
                elseif ping < 70 then
                    aleel.Aiming.Target.Prediction = 0.119
                elseif ping < 60 then
                    aleel.Aiming.Target.Prediction = 0.12731
                elseif ping < 50 then
                    aleel.Aiming.Target.Prediction = 0.127668
                elseif ping < 40 then
                    aleel.Aiming.Target.Prediction = 0.125
                elseif ping < 30 then
                    aleel.Aiming.Target.Prediction = 0.11
                elseif ping < 20 then
                    aleel.Aiming.Target.Prediction = 0.12588
                elseif ping < 10 then
                    aleel.Aiming.Target.Prediction = 0.9
                end
            end
            if WristPosBind and aleel.Aiming.WristPos.Enabled and WristPosTarget.Character and WristPosTarget.Character:FindFirstChild("HumanoidRootPart") then
                if LocalPlayer.Character.RightHand:FindFirstChild("RightWrist") then
                    LocalPlayer.Character.RightHand.RightWrist:Destroy()
                end
                repeat
                    task.wait()
                    LocalPlayer.Character.RightHand.CFrame = CFrame.new(WristPosTarget.Character.HumanoidRootPart.Position) * CFrame.new(0,aleel.Aiming.WristPos.Distance,0)
                    LocalPlayer.Character.RightHand.Transparency = 1
                until WristPosBind == false or aleel.Aiming.WristPos.Enabled == false
                if WristPosBind == false or aleel.Aiming.WristPos.Enabled == false then
        ...
        mt.__namecall = newcclosure(function(...)
            local args = {...}
            if aleel.Aiming.Target.Enabled and TargetBindEnabled and getnamecallmethod() == "FireServer" and args[2] == "UpdateMousePos" then
                args[3] = TargetTarget.Character[aleel.Aiming.Target.Hitbox].Position+Vector3.new(0,aleel.Aiming.Target.Offset.Y,0)+(TargetTarget.Character[aleel.Aiming.Target.Hitbox].Velocity*aleel.Aiming.Target.Prediction)
        ...
        RunService.RenderStepped:Connect(function ()
            if aleel.Aiming.Aimbot.VelocityResolver then
                pcall(function ()
            ...
            if aleel.Aiming.Aimbot.Enabled and AimbotBindEnabled and aleel.Aiming.Aimbot.Smoothing.Enabled == false then
                if aleel.Aiming.Aimbot.ReverseResolver == true then
                    local zxc = CFrame.new(workspace.CurrentCamera.CFrame.p, AimbotTarget.Character[aleel.Aiming.Aimbot.Hitbox].Position - AimbotTarget.Character[aleel.Aiming.Aimbot.Hitbox].Velocity/aleel.Aiming.Aimbot.Prediction)
                ...
                if aleel.Aiming.Aimbot.ReverseResolver == false then
                    local zxc = CFrame.new(workspace.CurrentCamera.CFrame.p, AimbotTarget.Character[aleel.Aiming.Aimbot.Hitbox].Position + AimbotTarget.Character[aleel.Aiming.Aimbot.Hitbox].Velocity/aleel.Aiming.Aimbot.Prediction)
                    workspace.CurrentCamera.CFrame = workspace.CurrentCamera.CFrame:Lerp(zxc, 1, Enum.EasingStyle.Elastic, Enum.EasingDirection.InOut)
                end
            elseif aleel.Aiming.Aimbot.Enabled and AimbotBindEnabled and aleel.Aiming.Aimbot.Smoothing.Enabled == true then
                if aleel.Aiming.Aimbot.ReverseResolver == true then
                    local zx = CFrame.new(workspace.CurrentCamera.CFrame.p, AimbotTarget.Character[aleel.Aiming.Aimbot.Hitbox].Position - AimbotTarget.Character[aleel.Aiming.Aimbot.Hitbox].Velocity/aleel.Aiming.Aimbot.Prediction)
                    workspace.CurrentCamera.CFrame = workspace.CurrentCamera.CFrame:Lerp(zx, aleel.Aiming.Aimbot.Smoothing.Value, Enum.EasingStyle.Elastic, Enum.EasingDirection.InOut)
                end
                if aleel.Aiming.Aimbot.ReverseResolver == false then
                    local zx = CFrame.new(workspace.CurrentCamera.CFrame.p, AimbotTarget.Character[aleel.Aiming.Aimbot.Hitbox].Position + AimbotTarget.Character[aleel.Aiming.Aimbot.Hitbox].Velocity/aleel.Aiming.Aimbot.Prediction)
                    workspace.CurrentCamera.CFrame = workspace.CurrentCamera.CFrame:Lerp(zx, aleel.Aiming.Aimbot.Smoothing.Value, Enum.EasingStyle.Elastic, Enum.EasingDirection.InOut)
            ...
            if TargetBindEnabled and aleel.Aiming.Target.Enabled and TargetTarget.Character and TargetTarget.Character:FindFirstChild("HumanoidRootPart") then
                if aleel.Aiming.Target.LookAt then
                    ...
                    spawn(function ()
                        if aleel.Aiming.Target.LookAt == false then
        ...
        RunService.Stepped:Connect(function (param,FPS)
            if aleel.Aiming.TargetStrafe.Enabled then
                if aleel.Aiming.Target.Enabled and TargetBindEnabled then
                    ...
                    angle_Y = angle_Y + FPS / aleel.Aiming.TargetStrafe.Speed % 1
                    LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(TargetTarget.Character.HumanoidRootPart.Position) * CFrame.Angles(0, 2 * math.pi * angle_Y, 0) * CFrame.new(0, aleel.Aiming.TargetStrafe.Height, aleel.Aiming.TargetStrafe.Distance)
                end
            end
        end)
        ...
        RunService.Heartbeat:Connect(function ()
            ...
            if aleel.Blatant.CFrame.Enabled then
                if LocalPlayer.Character.Humanoid.MoveDirection.Magnitude > 0 then
                    for i = 1, aleel.Blatant.CFrame.Value do
                        LocalPlayer.Character:TranslateBy(LocalPlayer.Character.Humanoid.MoveDirection)
                    end
                end
            end
            if aleel.Blatant.Exploits.JumpCooldown then
                LocalPlayer.Character.Humanoid.UseJumpPower = false
            else 
                LocalPlayer.Character.Humanoid.UseJumpPower = true
            end
            if aleel.Blatant.Exploits.NoSlow then
                wait()
            ...
            if aleel.Blatant.Exploits.AutoStomp then
                game.ReplicatedStorage.MainEvent:FireServer("Stomp")
            end
            if aleel.Blatant.Exploits.AntiBag then
                if LocalPlayer.Character["Christmas_Sock"] then
                    LocalPlayer.Character["Christmas_Sock"]:Destroy()
                end
            end
            if aleel.Blatant.AntiStomp.Enabled then
                if LocalPlayer.Character.Humanoid.Health <= 1 then
                    if aleel.Blatant.AntiStomp.Type == "Remove Character" then
                        for i, v in pairs(LocalPlayer.Character:GetDescendants()) do
                            if v:IsA("BasePart") then
                                v:Destroy()
                            end
                        end
                    elseif aleel.Blatant.AntiStomp.Type == "Remove Humanoid" then
                        LocalPlayer.Character.Humanoid:Destroy()
                    end
                end
            end
            if aleel.Blatant.FakeLag.Enabled then
                repeat
                    wait()
                    Toggles.AntiFlingEnabled:SetValue(true)
                    wait(aleel.Blatant.FakeLag.Duration/4)
                    Toggles.AntiFlingEnabled:SetValue(false)
                until aleel.Blatant.FakeLag.Enabled == false
            end
            if aleel.Blatant.AntiAim.VelocityUnderGround then
                VelocityUnderGroundAA()
            else
                LocalPlayer.Character.Humanoid.HipHeight = 2
            end
            if aleel.Blatant.AntiAim.RotVelocity.Enabled then
                RotVelocityAA()
            end
            if aleel.Blatant.GunMod.AutoReload then
        ...
        Toggles.RainbowModeXD:OnChanged(function()
            aleel.UISettings.Rainbow = Toggles.RainbowModeXD.Value
        end)
        ...
        function VelocityUnderGroundAA()
            ...
            LocalPlayer.Character.HumanoidRootPart.Velocity = Vector3.new(oldVelocity.X, -aleel.Blatant.AntiAim.VelocityUnderGroundAmount, oldVelocity.Z)
        ...
        function RotVelocityAA()
            LocalPlayer.Character.HumanoidRootPart.RotVelocity = Vector3.new(0, aleel.Blatant.AntiAim.RotVelocity.Value, 0)
        end
        
        task.spawn(function()
            while game:GetService("RunService").RenderStepped:Wait() do
                if aleel.UISettings.Rainbow then
